...
def getLink(soup):
    ...
    a_tag = soup.find("a", title = "List of American universities with Olympic metals")
...
class TestAllMethods(unittest.TestCase):
    ...
    def test_admissions_info(self):
        self.assertEqual(get_school_founded_year(self.soup), {'Literature Science, and the Arts': '1841',
                                                            'Medicine': '1850',
                                                            'Engineering': '1854', 
                                                            'Law': '1859',
                                                            'Dentistry': '1875', 
